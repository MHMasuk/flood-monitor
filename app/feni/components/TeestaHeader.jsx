        ...
        <>
            <div className="fixed top-0 w-full h-16 navbar bg-white text-neutral-content z-50 shadow-sm">
                <div className="navbar-start flex items-center gap-3">
                    ...
                    >
                        <Image
                            src="/qr_code/flood_monitor_feni.png"
                            alt="QR Code – scan to visit Feni flood monitor"
                            width={44}
                            height={44}
            ...
            {qrOpen && (
                ...
                >
                    ...
                    >
                        <p className="text-sm font-semibold text-gray-600">Scan to visit Feni Flood Monitor</p>
                        <Image
                            src="/qr_code/flood_monitor_feni.png"
                            alt="QR Code – Feni flood monitor"
                            width={260}
                            height={260}
